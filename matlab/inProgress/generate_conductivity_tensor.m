...
bst_progress('text', 'Calling Brainsuite  Load the eigen values and vectors...');
...
bst_progress('text', 'Calling Brainsuite  Load the masks...');
...
simNibsMask = bst_fullfile(bst_get('BrainstormUserDir'), 'simnibs_files',subjid,[subjid '_final_contr.nii.gz']);
...
switch meshGenerationMethod
    case  'simnibs'
        ...
        [sMri, vox2ras]  = in_mri(simNibsMask);
...
% for testing generate hexa mesh :
ft_defaults
cfg        = [];
cfg.shift  = 0.3;
